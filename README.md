...
MegaTransparency.com is a soon to be launched website centralizing open data/records, news reporting and data journalism, open data powered apps, and publishers and users of mostly government information. The Founder/Chief Innovation Officer of MegaTransparency.com is Tim Clemans, whose job is to overwhelm the competition with innovation and transparency. Tim's day: code all night, go to Farestart, code, eat, sleep, and right back at making the world better through open data. Performance goal: get Kevin Merritt, CEO of Socrata (Tim lives a block away from their HQ), to send a hastily written company wide email saying "we must take right a right turn right now or a homeless dude is going to put us out of business." Email us at info@megatransparency.com Note emails will be auto published. 
